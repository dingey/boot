...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
			<span class="logo-mini">boot</span> <!-- logo for regular state and mobile devices -->
		...
		<nav class="navbar navbar-static-top">
			...
			<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
				<ul class="nav navbar-nav">
					<li data-type="primary"><a class="btn">首页</a></li>
					<li data-type="primary"><a class="btn">设置</a></li>
				</ul>
			</div>
						...
						<ul class="dropdown-menu">
							...
							<li class="user-footer">
								...
								<div class="pull-right">
									<a href="#" class="btn btn-default btn-flat"><@spring.message
										"sign-out"/></a>
								</div>
							</li>
						</ul></li>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="treeview" data-value="首页"><a href="#"> <i class="fa fa-share"></i>
					...
					<ul class="treeview-menu">
						...
						<li><a href="#"><i class="fa fa-circle-o"></i> 一级 <span
								class="pull-right-container"> <i
									class="fa fa-angle-left pull-right"></i>
							</span> </a>
							<ul class="treeview-menu">
								<li><a href="#"><i class="fa fa-circle-o"></i>二级</a></li>
								<li><a href="#"><i class="fa fa-circle-o"></i>二级<span
										class="pull-right-container"> <i
											class="fa fa-angle-left pull-right"></i>
									</span> </a>
									<ul class="treeview-menu">
				...
				<li data-value="设置"><a href=""><i class="fa fa-fw fa-gears"></i> <span>设置</span></a>
					<ul class="treeview-menu">
						<li><a href="/admin/permission/list"><i
								class="fa fa-fw fa-key"></i>权限设置</a></li>
					</ul></li>
		...
		<section class="content">
			...
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs" id="tabs_head">
					<li class="pull-right dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#"> <i class="fa fa-gear"></i>
					</a>
						<ul class="dropdown-menu" style="min-width: 60px;">
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="#" onclick="closeTabs()"><@spring.message
									"close-all"/></a></li>
						</ul></li>
					<li class="active" id="li_tab_1"><a href="#tab_1"
						data-toggle="tab">Tab 1<i class="fa fa-fw fa-close"
							onclick="closeTab('1')"></i></a></li>
				</ul>
				<div class="tab-content" id="tabs_body">
					<div class="tab-pane active" id="tab_1">The European
						languages are members of the same family.</div>
					<!-- /.tab-pane -->
				</div>
				<!-- /.tab-content -->
			</div>
