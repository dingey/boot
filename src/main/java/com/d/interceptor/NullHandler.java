...
import com.d.util.NullUtil;

/**
 * @author di
 */
public class NullHandler implements HandlerInterceptor {
    /**
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) {
        modelAndView.addAllObjects(NullUtil.handlerModel(modelAndView.getModel()));
    }
